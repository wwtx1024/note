...
// 图片集合
var imgs = [,"https://dss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3173584241,3533290860&fm=26&gp=0.jpg","https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2534506313,1688529724&fm=26&gp=0.jpg","https://dss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2770382067,3204362577&fm=26&gp=0.jpg","https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3814539196,3915164343&fm=26&gp=0.jpg"]
for (let i = 1; i < 17; i++) {
    imgs.push('' + i + i)
}
...
function refreshImg() {
  ...
  if (verImg.length) {
    ...
    verImg.attr('src', imgs[index])

  } else {
    imgBox.prepend(`<img class='verImg' src="${imgs[index]}" />`)
  }
